!(function (e) {
  ...
  (__webpack_require__.m = e),
    ...
    __webpack_require__((__webpack_require__.s = 46));
})([
  function (e, t, r) {
    (function (t) {
  ...
  function (e, t, r) {
    ...
    e.exports = function (e, t) {
      ...
      var r,
        s = c(e, f);
      if (s) {
        if ((void 0 === t && (t = "default"), (r = n(s, e, t)), !o(r) || i(r)))
          return r;
  ...
  function (e, t, r) {
    ...
    var n = {
        ...
        removeVgoParam: function removeVgoParam(e) {
          var t = "";
          return (
            e.split("#").length > 1 && (t = "#".concat(e.split("#").pop())),
            (e = e.replace(t, ""))
              .replace(/vgo_ee=[^\&]+&?/, "")
              .replace(/[?&]$/, "") + t
          );
    ...
    function tracking_setPrototypeOf(e, t) {
      return (tracking_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(e, t) {
            return (e.__proto__ = t), e;
          })(e, t);
    ...
    function tracking_possibleConstructorReturn(e, t) {
      if (t && ("object" === tracking_typeof(t) || "function" == typeof t))
        return t;
      if (void 0 !== t)
        throw new TypeError(
          "Derived constructors may only return object or undefined"
    ...
    function web_personalization_setPrototypeOf(e, t) {
      return (web_personalization_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(e, t) {
            return (e.__proto__ = t), e;
          })(e, t);
    ...
    function web_personalization_createSuper(e) {
      ...
      return function _createSuperInternal() {
        var r,
          n = web_personalization_getPrototypeOf(e);
        if (t) {
    ...
    var l = {
      conversations: (function (e) {
        ...
        function Conversations(e, r) {
          ...
          return (
            ...
            ((n = t.call(this, e, r))._updateQueue = []),
            n
          );
        }
        return (
          (function conversations_createClass(e, t, r) {
            return (
              t && conversations_defineProperties(e.prototype, t),
              r && conversations_defineProperties(e, r),
              Object.defineProperty(e, "prototype", { writable: !1 }),
              e
            );
          })(Conversations, [
            {
              ...
              value: function connect() {
                ...
                var t = "https://"
                  .concat(i.a.cdnDomain, "/conversations/")
                  .concat("", "widget.js");
                n.async(
                  function () {
      ...
      tracking: (function (e) {
        ...
        function Tracking() {
          return (
            tracking_classCallCheck(this, Tracking), t.apply(this, arguments)
          );
        }
        return (
          (function tracking_createClass(e, t, r) {
            return (
              t && tracking_defineProperties(e.prototype, t),
              r && tracking_defineProperties(e, r),
              Object.defineProperty(e, "prototype", { writable: !1 }),
              e
            );
          })(Tracking, [
            {
              ...
              value: function connect() {
                ...
                var t =
                  (_defineProperty((e = {}), a, this.visitor.accountId),
                  _defineProperty(e, s, this.visitor.id),
      ...
      wp: (function (e) {
        ...
        function WebPersonalization(e) {
          ...
          return (
            ...
            ((r = t.call(this, e))._updateQueue = []),
            r
          );
        }
        return (
          (function web_personalization_createClass(e, t, r) {
            return (
              t && web_personalization_defineProperties(e.prototype, t),
              r && web_personalization_defineProperties(e, r),
              Object.defineProperty(e, "prototype", { writable: !1 }),
              e
            );
          })(WebPersonalization, [
    ...
    var p = (function () {
      function Visitor(e) {
        !(function visitor_classCallCheck(e, t) {
          ...
          (this._accountId = e),
          (this._email = null),
          (this._referrer = n.getReferrer()),
          (this._url = n.getLocation()),
          (this._hasWhitelistedServices = !1),
          (this._whitelistedServices = []),
          (this._addedServices = []),
          (this._processedServices = {}),
          (this._trackByDefault = !1),
          (this._siteAllowParameter = !0);
      }
      return (
        (function visitor_createClass(e, t, r) {
          return (
            t && visitor_defineProperties(e.prototype, t),
            r && visitor_defineProperties(e, r),
            Object.defineProperty(e, "prototype", { writable: !1 }),
            e
          );
        })(Visitor, [
          ...
          {
            key: "siteAllowParameter",
            get: function get() {
              return this._siteAllowParameter;
            },
            set: function set(e) {
              var t = e;
              switch (e) {
    ...
    function getTempCookieExpiration() {
      return new Date(new Date().getTime() + 5e3);
    }
    function getCookies() {
    ...
    function getDiffuserCookie(e) {
      ...
      return getCookies()[getDiffuserCookieName(e)] || "";
    }
    function getTempEeCookie() {
      return getCookies().temp_ee || "";
    }
    ...
    var _ = "a",
      ...
      g = (function () {
        ...
        return (
          (function diffuser_createClass(e, t, r) {
            return (
              t && diffuser_defineProperties(e.prototype, t),
              r && diffuser_defineProperties(e, r),
              Object.defineProperty(e, "prototype", { writable: !1 }),
              e
            );
          })(Diffuser, [
            ...
            },
            {
              ...
              value: function _executeSetAccount(e) {
                var t = window.location.href,
                  r = this._visitors[e];
                (r && r._url === t) ||
                  ((this._visitors[e] = new p(e)),
                  r &&
                    !this._visitors[e]._referrer &&
                    (this._visitors[e]._referrer = r._url)),
                  (this._accountId = e);
              },
            },
            {
            ...
            {
              key: "_executeSetSiteAllowParameter",
              value: function _executeSetSiteAllowParameter(e) {
                (this._getVisitor().siteAllowParameter = e),
                  (this._visitors.siteAllowParameter = e);
              },
            },
            {
            ...
            },
            {
              ...
              value: function _executeProcess(e) {
                var t = this,
                  r = this._getVisitor();
                (!1 === r.trackByDefault && "allowTracking" !== e) ||
                  n.async(function () {
            ...
            },
            {
              ...
              value: function _makeRequestToDiffuser(e, t) {
                var r,
                  o =
                    (diffuser_defineProperty((r = {}), _, e.accountId),
                    diffuser_defineProperty(r, d, e.email),
                    diffuser_defineProperty(r, b, n.getQueryParam("vgo_ee")),
                    diffuser_defineProperty(r, h, e.url),
                    diffuser_defineProperty(r, y, e.referrer),
                    ...
                    r);
                this._removeQueryParam(e.siteAllowParameter),
                  this._checkQueryParam(e.accountId) &&
                    "" === o[b] &&
                    (o[b] = atob(getTempEeCookie()));
            ...
            },
            {
              ...
              value: function _executeUpdate(e) {
                var t = this;
                e || this.initialized
                  ? Object.values(this._visitors).map(function (r) {
            ...
            },
            {
              ...
              value: function _removeQueryParam(e) {
                if (-1 !== window.location.href.indexOf("vgo_ee")) {
                  var t = this._checkResponseStatusExists(
                    window.performance.getEntriesByName(window.location.href),
                    e
                  );
                  !(function setTempEeCookie(e) {
                    var t =
                        arguments.length > 1 && void 0 !== arguments[1]
                          ? arguments[1]
                          : 0,
                      r = getTempCookieExpiration(),
                      n =
                        "." +
                        window.location.hostname
                          .split(".")
                    ...
                    document.cookie = ""
                      .concat("temp_ee", "=")
                      .concat(e, ";domain=")
                      .concat(n, ";path=/;expires=")
                      .concat(r.toUTCString());
                    var o = getTempEeCookie();
                    if (!o && t < 10) return setTempEeCookie(e, t + 1);
                  })(btoa(n.getQueryParam("vgo_ee"))),
                    window.history.replaceState(
                      window.history.state,
                      document.title,
                      n.getPathname()
                    ),
                    t && window.location.replace(window.location.href);
                }
              },
            },
            {
              key: "_checkResponseStatusExists",
              value: function _checkResponseStatusExists(e, t) {
                if (1 === e.length && void 0 !== e[0].responseStatus)
                  return 404 === e[0].responseStatus;
                if (!1 === t) {
                  var r = new XMLHttpRequest();
                  return (
                    r.open("GET", window.location.href, !1),
                    r.send(null),
                    404 === r.status
                  );
                }
            ...
            {
              key: "_checkQueryParam",
              value: function _checkQueryParam(e) {
